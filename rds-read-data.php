...
<?php
  ...
  isset($_REQUEST['firstname']) ? $name=$_REQUEST['firstname'] : $firstname="";
  isset($_REQUEST['lastname']) ? $name=$_REQUEST['lastname'] : $lastname="";
...
if ( $mode=="add")
 ...
 if ( $mode=="added")
 {
 mysql_query ("INSERT INTO address (firstname, lastname, phone, email) VALUES ('$firstname', '$lastname', '$phone', '$email')");
 }
...
if ( $mode=="edit")
 ...
 if ( $mode=="edited")
 {
 mysql_query ("UPDATE address SET firstname = '$firstname', lastname = '$lastname', phone = '$phone', email = '$email' WHERE id = $id");
